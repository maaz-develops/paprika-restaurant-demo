...
const LOGO_URL = `${import.meta.env.BASE_URL}paprika-logo.png`;
      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between gap-1.5 sm:gap-2 p-1.5 sm:p-2.5 rounded-full glass-surface border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgba(0,0,0,0.08)] pointer-events-auto transition-all">
        ...
        >
          <motion.div
            ...
            className="w-8 h-8 sm:w-9 sm:h-9 rounded-full overflow-hidden bg-stone-900 border border-white/20 flex items-center justify-center p-0.5 shadow-sm shrink-0"
          >
            <img
              src={LOGO_URL}
        ...
        <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2 shrink-0">
          ...
          <a
            ...
            aria-label="Call Paprika Restaurant"
          ...
          {onOpenCart && (
            <button
              ...
              aria-label="View dining bag and checkout"
