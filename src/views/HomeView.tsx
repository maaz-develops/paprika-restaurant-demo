...
import { Sparkles, ArrowRight, Calendar, Phone, MessageSquare, MapPin, Award, ShieldCheck, ChevronRight, ChevronLeft, Plus, Camera } from 'lucide-react';
...
const HALL_VIEWS = [
  ...
  {
    id: 'fine-dining',
    src: '/paprika-interior-original.jpg',
...
export const HomeView: React.FC<HomeViewProps> = ({ onNavigateTab, onSelectDish, onAddToCart }) => {
  const featuredDishes = MENU_DISHES.filter((d) => d.isChefSpecial || d.isPopular).slice(0, 4);
  ...
  const handlePrevHall = () => {
    setActiveHallIndex((prev) => (prev - 1 + HALL_VIEWS.length) % HALL_VIEWS.length);
  };

  return (
    <div className="space-y-16 sm:space-y-24 pb-20 select-none">
      {/* ==================================================== */}
      {/* 1. CINEMATIC HERO (REAL PAPRIKA EXTERIOR PHOTOGRAPH) */}
      {/* ==================================================== */}
      <section className="relative w-full rounded-[2.5rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.18)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.7)] border border-white/60 dark:border-white/10">
        <div className="relative min-h-[580px] sm:min-h-[660px] flex flex-col justify-between p-6 sm:p-12 text-white">
          {/* Authentic Exterior Photo Background with parallax scale */}
          ...
          <div className="relative z-10 flex items-center justify-between">
            ...
            >
              ...
              <span>Businessman Colony, RYK</span>
            </motion.div>
          </div>

          {/* Center-Bottom Editorial Hero Copy */}
          <div className="relative z-10 max-w-2xl space-y-6 pt-24">
            ...
            {/* CTAs: EXPLORE MENU & RESERVE TABLE (Liquid Glass Buttons) */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      {/* ==================================================== */}
      {/* 2. THE PAPRIKA EXPERIENCE (ASYMMETRIC EDITORIAL)    */}
      {/* ==================================================== */}
      <section className="relative px-2 sm:px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          {/* Asymmetric Large Photography Showcase */}
          <div className="lg:col-span-7 relative group">
            {/* Real Interior Photography Switcher */}
            <div className="relative rounded-[2rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.6)] border border-white/60 dark:border-white/10 bg-stone-900 aspect-[4/3] sm:aspect-[16/11]">
              ...
              {/* Bottom Details & Direct Image Switcher */}
              <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4 text-white z-10 space-y-2 sm:space-y-2.5">
                ...
                {/* Thumbnails to switch between the hall and cafe views */}
                  ...
                  {HALL_VIEWS.map((view, idx) => (
                    ...
                    >
                      ...
                      <span className="absolute bottom-1 left-1 sm:left-1.5 right-1 sm:right-1.5 text-[8px] sm:text-[9px] font-semibold text-white truncate drop-shadow block leading-tight">
                        {idx === 0 ? 'Buffet Hall' : idx === 1 ? 'Night Cafe' : 'Fine Dining'}
                      </span>
                    </button>
                  ))}
                </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-light text-stone-900 dark:text-stone-100 tracking-tight leading-[1.15]">
              THE PAPRIKA <br />
              <span className="font-semibold italic text-[#9B1B1E] dark:text-[#E6B87D]">EXPERIENCE</span>
            </h2>
            ...
            >
              <span>Discover our architectural heritage</span>
      ...
      {/* ==================================================== */}
      {/* 3. FEATURED DISHES (AUTHENTIC PAPRIKA DISHES)        */}
      {/* ==================================================== */}
      <section className="space-y-8 px-2 sm:px-4">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          >
            <span>Full Menu ({MENU_DISHES.length} Specialties)</span>
            <ChevronRight className="w-4 h-4" />
          </button>
        </div>

        {/* Dish Grid with iOS liquid glass cards */}
      ...
      {/* ==================================================== */}
      {/* 4. HOSPITALITY / CONTACT GLASS BANNER                */}
      {/* ==================================================== */}
      <section className="relative px-2 sm:px-4">
        <div className="relative rounded-3xl p-6 sm:p-10 glass-surface border border-white/70 dark:border-white/10 shadow-[0_15px_40px_rgba(0,0,0,0.1)] overflow-hidden">
          {/* Subtle background crystal shine */}
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            {/* Exact WhatsApp and Phone links as mandated */}
